                ...
                <div className="notif-content">
                    ...
                    <div className="notif-item">
                        ...
                        <div className="notif-item-content">
                            <span className="text mb-0 bold">Reporte de avería <span className="status-label">Nuevo</span> </span>
                            <span className="text-small label-color">La insidencia reportada en fecha 14 de Noviembre 2021, ha sido resuelta exitosamente.</span>
                        </div>
                    </div>
                    <div className="notif-item">
                        <span className="notif-icon">
