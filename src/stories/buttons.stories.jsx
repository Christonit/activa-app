...
import {
    ...
    InputFieldWithIcon as InputFieldWithIconComp,
...
export const InputWithLabel = ({label = "[text]"}) => (
    <div>
        <div className="form-label">
            <label for="field" className="">
                {label}
            </label>
        </div>
...
export const SixInputField = () => (
    <div class="input-groups-code">
